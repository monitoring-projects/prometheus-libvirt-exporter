...
```bash
ssh-keygen -t rsa -b 4096 -f ~/.ssh/id_rsa_libvirt
ssh-copy-id -i ~/.ssh/id_rsa_libvirt root@node1.example.com
ssh-copy-id -i ~/.ssh/id_rsa_libvirt root@node2.example.com
